...
```
i3nux-mint@i3nuxmint-HP-Pavilion-Gaming-Laptop:~/.config/rofi$ ls
files  fonts  README.md  setup.sh
i3nux-mint@i3nuxmint-HP-Pavilion-Gaming-Laptop:~/.config/rofi$ ls files/
applets  colors  config.rasi  images  launchers  powermenu  scripts
i3nux-mint@i3nuxmint-HP-Pavilion-Gaming-Laptop:~/.config/rofi$ cat .i3/config
```
